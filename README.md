...
Pada percobaan yang kami lakukan, Teknik Preprocessing yang digunakan adalah resizing, greyscaling, thresholding, noise reduction, edge detection, normalisasi
